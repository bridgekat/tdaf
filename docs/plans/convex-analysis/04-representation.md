...
**Theorem 17.3** still needs **Corollary 9.6.1** — the convex cone generated by a compact convex set
not containing the origin is closed. Everything else in its proof is available.
