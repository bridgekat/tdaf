...
## 1.4 `Tdaf/Analysis/Convex/Concave.lean` — see [D2](../00-overview.md#d2-concave-notions-are-named-but-defined-and-proved-through-negation)
...
## 1.7 `Tdaf/Analysis/Convex/Homogenize.lean` — [D6](../00-overview.md#d6-homogenisation-is-a-first-class-operation)
