...
| `Bifunction/Algebra.lean` | §38 — the convex algebra: `infConvBifun` (`F₁ □ F₂`), `infConvFstBifun` (the same in the first variable), `smulRightBifun`, `imageBifun`, `compBifun`, `invBifun` (`F⫶`), `lowerAdjointBifun` (`F⫶*`), and the inner product `fenchelSup`/`fenchelInf`/`fenchelPairing`; **Thms 38.1–38.5 and 38.7**, **Lemma 38.6**, **Cors 38.2.1, 38.4.1, 38.5.1, 38.7.1** and the first equality of **Cor 38.7.2** |
