...
proved, only unlabelled — the session that wrote the file had no copy of the book. What is still
missing is **Corollary 32.3.3**, which needs the lineality space of `C` quotiented out.
