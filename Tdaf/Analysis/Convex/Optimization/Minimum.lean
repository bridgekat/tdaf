...
* R. T. Rockafellar, *Convex Analysis*, Princeton University Press, 1970, §27 (Theorem 27.1(a),
  (b), Theorem 27.2 with Corollaries 27.2.1–27.2.2, Theorem 27.3 with Corollaries 27.3.2 and
  27.3.3, Theorem 27.4).
-/
